...
import { CourseResponse, CategoryResponse } from '@/lib/lms-api-client';
import EnrollButton from '@/components/LMS/EnrollButton';

export default function BrowseLMSCoursesPage() {
    ...
    <div className="flex flex-col">
      ...
      <div className="flex-1 p-6">
        ...
        <Tabs defaultValue="all" className="space-y-6">
          <TabsList>
            <TabsTrigger value="all">Tất cả khóa học ({filteredCourses.length})</TabsTrigger>
